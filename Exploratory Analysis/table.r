...
# The table displays total casualties due to wildfire in California, ordered by year. This table serves to display the real human cost of these fires, and climate change as a whole.
# The table shows a sharp increase in deaths beginning in 2017, peaking in 2018, and decreasing in 2019.